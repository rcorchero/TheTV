...
class GetAiringTodayTVShowsUseCase @Inject constructor(private val repository: TVShowsRepository) {

    suspend operator fun invoke(): Either<Failure, List<TVShow>> = repository.getAiringToday()
}